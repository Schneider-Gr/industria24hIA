...
LANGSMITH_PROJECT=REPLACE_ME   # optional, defaults to "default"
...
FIREWORKS_API_KEY=REPLACE_ME
TOGETHER_API_KEY=REPLACE_ME
HUGGINGFACEHUB_API_TOKEN=REPLACE_ME

# Common tool/retrieval services
TAVILY_API_KEY=REPLACE_ME          # for Tavily search
PINECONE_API_KEY=REPLACE_ME        # for Pinecone
```
</environment-variables>
