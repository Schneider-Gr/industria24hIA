...
- [ ] Admin fala com comprador e loja em canais privados separados, sem vazamento entre os dois *(mensagem do comprador confirmada ao vivo como invisível para a loja; verificação completa do lado admin com as duas threads lado a lado não concluída por instabilidade do browser de teste — RLS confirmada via query direta, ver §9 10/08/2026)*
