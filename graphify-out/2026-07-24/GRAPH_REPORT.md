...
## Corpus Check
- 101 files · ~102,015 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 359 nodes · 844 edges · 24 communities (19 shown, 5 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ce797a0`
...
### Community 3 - "run.ts"
Cohesion: 0.19
Nodes (28): gerarIdentificador(), solicitarAfiliacao(), AfiliadoLayout(), AfiliadoPage(), AfiliadosPage(), AnaliseGeralPage(), CentrosPage(), MinhaLojaPage() (+20 more)
...
Cohesion: 0.08
Nodes (24): dependencies, next, react, react-dom, @sentry/nextjs, @supabase/ssr, @supabase/supabase-js, devDependencies (+16 more)

### Community 8 - "page.tsx"
Cohesion: 0.13
Nodes (26): AfiliadosPage(), TODO: requer policy is_admin (leitura cross-seller de afiliacoes)., AnaliseGeralPage(), count(), LojasPage(), TODO: requer policy is_admin (hoje a RLS escopa por owner_id)., AdminDashboard(), monthStartISO() (+18 more)
...
Cohesion: 0.09
Nodes (35): Acesso, AcessosPage(), TODO: requer policy is_admin para escrita cross-seller em afiliacoes., setStatusAfiliacao(), criarCategoria(), criarSubcategoria(), excluirCategoria(), excluirSubcategoria() (+27 more)
...
## Knowledge Gaps
- **120 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+115 more)
