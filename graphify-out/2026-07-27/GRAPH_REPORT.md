...
## Corpus Check
- 117 files · ~113,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 452 nodes · 772 edges · 45 communities (30 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 9 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57a3a9da`
...
### Community 3 - "run.ts"
Cohesion: 0.17
Nodes (33): gerarIdentificador(), solicitarAfiliacao(), AfiliadoLayout(), AfiliadoPage(), SolicitarAfiliacaoPage(), GET(), moderarAfiliacao(), AfiliadosPage() (+25 more)
...
Cohesion: 0.08
Nodes (23): Acesso, AcessosPage(), criarCategoria(), criarSubcategoria(), excluirCategoria(), excluirSubcategoria(), CategoriasPage(), salvarMarketplaceConfig() (+15 more)
...
## Knowledge Gaps
- **183 isolated node(s):** `config`, `This is NOT the Next.js you know`, `O Projeto`, `1. Dados e Backend — PROIBIDO mockar`, `2. Nunca invente schema` (+178 more)
...
- **What connects `config`, `This is NOT the Next.js you know`, `O Projeto` to the rest of the system?**
