...
- [~] 6.1 Rodar os cenários dos dois specs manualmente — parcial: build de produção passou com todas as rotas novas geradas (`/afiliado/lote`, `/afiliado/vitrines`, `/afiliado/vitrines/[id]`, `/vitrine-afiliado/[slug]`); teste ponta a ponta em browser real fica para a etapa de QA online (deploy)
