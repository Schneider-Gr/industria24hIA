...
- **Tarifa por classe de veículo** da loja (tarifa mínima + R$/km), definida
  pelo seller, com piso por classe da plataforma. Classe = menor que aguenta o
...
- Repasse ao entregador e mensagens de status da corrida ficam fora
  (brainstorms próprios).
