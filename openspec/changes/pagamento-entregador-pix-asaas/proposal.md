...
- Troca da chave Pix confirmada por código enviado por SMS, para entregador,
  seller e afiliado de vendas.
...
- Comissão da plataforma sobre a corrida: 5%, já aplicada (migration 0197, #789).
