...
- [x] 1.3 Tipos de `database.types.ts` para as colunas, tabelas e RPC novas
...
- [x] 2.5 CEP de origem do produto normalizado (D10)

## 3. Seller

- [x] 3.1 Cadastro e edição da transportadora própria, com motivo visível quando desativada pelo admin
- [x] 3.2 Upload no formato novo com preview e confirmação pela RPC; remover cotação por envio e sobrescrita de global
- [x] 3.3 Categorias por nó com contador de produtos
- [x] 3.4 Globais com ativar/desativar, código de cliente e aceite
- [x] 3.5 Painel de pendências
- [x] 3.6 Modelo de planilha para download

## 4. Admin

- [x] 4.1 Cadastro da global com os campos novos e upload pela RPC
- [x] 4.2 Data de encerramento; cron que avisa 7 dias antes
- [x] 4.3 E-mail "tabela atualizada" às lojas que ativaram
- [x] 4.4 Transportadoras próprias de todas as lojas com desativar e motivo

## 5. Entrega

- [x] 5.1 `npm run lint`, `npm run build` e `npm run test`
