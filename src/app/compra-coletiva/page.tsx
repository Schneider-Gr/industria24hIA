  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1">
        {/* Hero */}
        <section className="relative overflow-hidden bg-lm-marinho">
          <div className="relative mx-auto max-w-[880px] px-4 py-16 sm:px-6 sm:py-24">
            <p className="font-archivo text-sm font-bold uppercase tracking-wide text-lm-azul">
              Compra Coletiva
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link
                href="/coletivas"
                className="rounded-sm bg-lm-azul px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-lm-azul-escuro"
              >
        ...
        <section className="mx-auto max-w-[880px] px-4 py-14 sm:px-6">
          ...
          <h2 className="mt-2 font-archivo text-2xl font-extrabold text-lm-marinho sm:text-3xl">
          ...
          <ol className="mt-8 grid gap-5 sm:grid-cols-2">
            {[
              ...
              <li key={p.n} className="rounded-sm border-l-4 border-lm-azul bg-lm-cinza p-5">
                <span className="font-archivo text-2xl font-extrabold text-lm-azul">{p.n}</span>
                <h3 className="mt-2 font-archivo text-base font-bold text-lm-marinho">{p.t}</h3>
                <p className="mt-1.5 text-sm text-lm-marinho">{p.d}</p>
              </li>
            ))}
          </ol>
        </section>
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-3">
            {[
              ...
              <div key={b.t} className="rounded-sm border border-lm-marinho bg-white p-5 shadow-sm">
                <h3 className="font-archivo text-base font-bold text-lm-marinho">{b.t}</h3>
                <p className="mt-1.5 text-sm text-lm-marinho">{b.d}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        {/* Pagamento e prazo */}
        <section className="bg-lm-cinza/60">
          <div className="mx-auto max-w-[880px] px-4 py-14 sm:px-6">
            ...
            <div className="mt-8 grid gap-5 sm:grid-cols-2">
              <div>
                <h3 className="font-archivo text-base font-bold text-lm-marinho">Cobrança individual</h3>
                <p className="mt-1.5 text-sm text-lm-marinho">
              ...
              <div>
                <h3 className="font-archivo text-base font-bold text-lm-marinho">Prazo para pagar</h3>
                <p className="mt-1.5 text-sm text-lm-marinho">
          ...
          <div className="mt-8 space-y-6">
            {[
              ...
              <div key={f.p} className="border-b border-line pb-6 last:border-0 last:pb-0">
                <h3 className="font-archivo text-base font-bold text-lm-marinho">{f.p}</h3>
                <p className="mt-1.5 text-sm text-lm-marinho">{f.r}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-lm-azul">
          <div className="mx-auto max-w-[880px] px-4 py-16 text-center sm:px-6">
            ...
            <Link
              href="/coletivas"
              className="mt-6 inline-block rounded-sm bg-white px-8 py-3 text-sm font-semibold text-lm-azul transition-colors hover:bg-lm-cinza"
            >
              Ver coletivas abertas
            </Link>
          </div>
