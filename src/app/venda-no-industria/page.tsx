  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <a
        ...
        aria-label="Falar no WhatsApp com um consultor"
        className="font-display fixed bottom-40 right-4 z-50 flex items-center gap-2.5 rounded-full bg-[#25D366] p-4 text-sm font-bold text-white shadow-lg transition-[filter] hover:brightness-95 sm:px-5 sm:py-3.5"
      >
