...
export function BotaoComprarRapido({ produto }: { produto: Omit<ItemCarrinho, "quantidade"> }) {
  ...
  return (
    <button
      ...
      onClick={aoClicar}
      title="Comprar agora"
      className="inline-flex h-8 shrink-0 items-center justify-center gap-1 rounded-full bg-lm-amarelo px-3 text-[12px] font-bold text-lm-marinho shadow-sm transition-colors hover:brightness-95"
    >
