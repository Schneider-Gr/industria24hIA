...
import { RANGE_KEYS, RANGE_LABEL, type RangeKey } from "@/lib/dashboard-kpis";

// Abas de período reaproveitadas pelos dashboards (admin, seller, repasses).
// Server component: só links; o estado vive no query param `?range=`.
// `basePath` é a rota que recebe o `?range=` (default `/admin`).
