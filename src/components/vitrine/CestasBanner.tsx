...
export function CestasBanner() {
  return (
    <section className="max-w-[1280px] mx-auto px-4 sm:px-6 mt-10 mb-2">
      <div className="grid overflow-hidden rounded-[22px] border border-line sm:grid-cols-2">
        <div className="flex flex-col justify-center gap-3.5 bg-green-soft p-8 sm:p-11">
          <p className="text-xs font-semibold uppercase tracking-[.12em] text-green-fresh">
            Em breve
          </p>
          ...
          <button
            ...
            className="mt-1.5 w-fit cursor-not-allowed rounded-full bg-green-fresh/40 px-6 py-3 text-sm font-bold text-white"
          >
            Assinatura em breve
          </button>
        </div>

        <div className="flex min-h-[220px] items-center justify-center bg-green-fresh">
          <svg width="150" height="150" viewBox="0 0 200 200" fill="none" aria-hidden>
            ...
            <path
              ...
              strokeLinecap="round"
            />
            <path d="M50 100h100M46 130h108" stroke="#3E7D34" strokeWidth="4" opacity=".4" />
