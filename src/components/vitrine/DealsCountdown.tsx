    ...
    <div className="bg-purple-deep">
      <div className="mx-auto flex max-w-[1280px] flex-wrap items-center justify-between gap-2 px-4 py-3 sm:px-6">
        <div className="flex items-center gap-3">
          <span className="rounded-full bg-red-signal px-3 py-1 text-[12.5px] font-extrabold text-white">
            RELÂMPAGO
          </span>
          <span className="text-[13px] font-semibold text-white/90">Ofertas encerram em</span>
          <span className="font-mono text-[15px] font-bold tracking-[0.03em] text-yellow-worker" suppressHydrationWarning>
            {restante ?? "--:--:--"}
          </span>
        </div>
