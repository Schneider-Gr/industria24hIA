...
export function GaleriaProduto({
  ...
  return (
    <div className="space-y-3">
      <div
        className="relative mx-auto aspect-square w-full max-w-[280px] touch-pan-y select-none overflow-hidden rounded-lg border border-[#E5E7EB] bg-white sm:max-w-[360px] md:max-w-[420px]"
      ...
      {ordenadas.length > 1 && (
        <div className="mx-auto grid max-w-[280px] sm:max-w-[360px] md:max-w-[420px] grid-cols-4 gap-2">
          {ordenadas.map((img, i) => (
            <button
