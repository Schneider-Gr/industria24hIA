...
export function HeroDialBadge() {
  return (
    <div
      ...
      aria-hidden
    >
      <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-dashed border-yellow-worker/50">
        <span
          className="absolute left-1/2 top-1/2 h-[1.6px] w-[9px] origin-left rounded-sm bg-yellow-worker"
          style={{ animation: "girar-ponteiro 9s linear infinite" }}
        />
        <span
          className="absolute left-1/2 top-1/2 h-[1.2px] w-[13px] origin-left rounded-sm bg-yellow-worker opacity-70"
        ...
        <span className="text-center font-display text-[10px] font-black leading-tight text-white">
          24h
          <span className="block font-sans text-[6px] font-bold tracking-[0.08em] text-yellow-worker">
            ABERTO
          </span>
        </span>
      </div>
