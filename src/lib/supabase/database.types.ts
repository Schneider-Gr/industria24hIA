  ...
  public: {
    Tables: {
      ...
      cupom_regras: {
        ...
        Relationships: [
          {
            foreignKeyName: "cupom_regras_cupom_id_fkey"
            columns: ["cupom_id"]
            isOneToOne: false
      ...
      linha_itens: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "linha_itens_cupom_id_fkey"
            columns: ["cupom_id"]
            isOneToOne: false
            referencedRelation: "cupons"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cotar_frete_tabela: {
        Args: { p_cep: number; p_loja_id: string; p_peso: number }
        Returns: {
          transportadora_id: string
          valor: number
        }[]
      ...
      cupom_desconto_item: {
        Args: {
          ...
          p_qtd: number
          p_regras: Json
          p_repasse_ind: number
        }
        Returns: number
      }
      cupom_liberar_uso_pedido: {
        Args: { p_pedido_id: string }
        Returns: undefined
      }
      cupom_preco_item: {
      ...
      registrar_acesso_negado: {
        Args: { p_papel: string; p_rota: string }
        Returns: undefined
      }
