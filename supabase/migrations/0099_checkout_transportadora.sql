...
--     (mercado_envios = cotação externa, ainda não suportada no checkout via RPC);
--   - casa a faixa por transportadora (transportadora_id is not distinct from ...);
--   - grava linha_itens.transportadora_id.
-- Frete continua = round(valor_item * percentual/100, 2).
