-- 0099: colunas de rastreamento Uber Direct na tabela rotas (PRD 008).
...
-- revelou colisão com 0098_seller_carrinhos_abandonados (renumerada de 0098
-- para 0099) — idempotente para não quebrar um futuro db push.
